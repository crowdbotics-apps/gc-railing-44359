"""
Django settings for gc_railing_44359 project.
...
ROOT_URLCONF = 'gc_railing_44359.urls'
...
WSGI_APPLICATION = 'gc_railing_44359.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gc_railing_44359 API",
    "DESCRIPTION": "API documentation for gc_railing_44359 App",
    "VERSION": "v1",
}
